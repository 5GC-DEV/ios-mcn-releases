# IOS MCN v0.3.0 Agartala Release: CORE Installation Guide
...
```
wget https://github.com/ios-mcn/ios-mcn-releases/raw/main/Agartala/v0.3.0/CORE/release-images/iosmcn.agartala.v0.3.0.core.images.tar.gz
