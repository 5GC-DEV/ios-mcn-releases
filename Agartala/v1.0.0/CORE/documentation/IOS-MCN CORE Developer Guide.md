...
# **IOS MCN v1.0.0 Agartala Release: CORE Developer Guide**
...
```sh
wget https://github.com/ios-mcn/ios-mcn-releases/raw/refs/heads/main/Agartala/v1.0.0/CORE/source-code/iosmcn.agartala.v1.0.0.core.source.tar.gz
```

Step 3: Untar the iosmcn.agartala.v1.0.0.core.source.tar.gz.

```sh
tar -xvzf iosmcn.agartala.v1.0.0.core.source.tar.gz
cd iosmcn.agartala.v1.0.0.core.source
```

Step 4: Untar the network functions -  *\<nf>*-0.0.*\<nf-version>*.iosmcn.core.*\<nf>*.tar.gz.

```sh
tar -xvzf amf-1.0.0.iosmcn.core.amf.tar.gz
cd amf-1.0.0.iosmcn.core.amf
```
or

```sh
tar -xvzf smf-1.0.0.iosmcn.core.smf.tar.gz
cd smf-1.0.0.iosmcn.core.smf
```
...
...
- If the core is installed and you want to update the pod with the new images and reset the core, run the following command:
	```sh
	cd ~/IOSMCN-Core/iosmcn.agartala.v1.0.0.core.images/IOSMCN-CoreDpm
